...
public class TableReservation  {
    ...
    private static void tableResMainPage(){
        int option;
        do{
                ...
                case 1:
                    ...
                    if(rm.ifexist(contact) == 0){
                        ...
                        if(rm.isReservationInAdvance(dtTime) == false){
                            ...
                            //7200 translates to 2hrs in epoch
                            ArrayList<Integer> num = new ArrayList<Integer>();
		                    for(int i=0; i<rm.getReservationList().size(); i++){
			                    if((dtTime < (rm.getReservationList().get(i).getEpochDateTime() + 7200)) && 
			                        (dtTime+7200) > (rm.getReservationList().get(i).getEpochDateTime() + 7200)){
