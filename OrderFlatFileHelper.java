...
public class OrderFlatFileHelper extends Manager{
    ...
    public static void main(String[] args){
        ...
        String dateTime = DateTime.epochToDate(orderHelper.orderInvoices.get(0).getOrderDateTime(), true);
...
//*************change to long
    ...
    //     orderHelper.addToArray(new OrderInvoice(123, 456, 789, 4, 1631635200000L, "burger/2|fries/2|milkshake/2|", 12, 14,1,2,3));
    //     orderHelper.addToArray(new OrderInvoice(123, 456, 789, 4, 1635270785756L, "burger/2|fries/2|milkshake/2|", 12, 14,1,2,3));
